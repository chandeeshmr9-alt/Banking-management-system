...
const stats = [
  { label: "Total Accounts", icon: Wallet, accent: "from-sky-500 to-cyan-500" },
  { label: "Total Balance", icon: Landmark, accent: "from-emerald-500 to-teal-500" },
  { label: "High Value Accounts", icon: Banknote, accent: "from-amber-500 to-orange-500" },
] as const;
...
export default function AccountStats({
  ...
  const values = [String(totalAccounts), formatCurrency(totalBalance), String(highValueAccounts)];
